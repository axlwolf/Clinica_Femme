...
/**
 * Implementação da View de um módulo de banner
 * @author	mauricio
 */
abstract class AbstractBannerView extends CrudView {

	/**
	 *
	 * @var string
	 */
	protected $contentPage = 'banner/view/templates/default.html';
	...
	public function __construct(){
		...
		$this->setResourceTitle( $resourceBundle->getString( 'BANNERS_PAGE_TITLE' ) );
		$this->setResourceDescription( $resourceBundle->getString( 'BANNERS_PAGE_DESCRIPTION' ) );
	...
	public function setContentSubPage( $page ){
		$this->contentSubPage = 'banner/view/templates/'. $page;
		$this->assign( 'contentSubPage', 'banner/view/templates/'.$page );
	}
	 ...
	 */
	public function setTab( $tab = 'banner'){
		$this->tab = $tab;
		$this->assign( 'tab', $tab );
	}
}